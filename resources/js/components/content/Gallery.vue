<template>
  <div class="container-fluid">
    ...
    <div>
      <p>Themen</p>
      <ul>
        <li v-for="topic in filters.topics" :key="topic.name">
          <input
            type="checkbox"
            v-bind:value="topic"
            :id="topic"
    ...
    <div class="row" v-for="image in filtered" :key="image.Filename">
      ...
      Kommentare:
      <div v-for="comment in image.comments" :key="comment.Text">
        <p>{{comment.Text}}</p>
        <br />
      </div>
      <star-rating
