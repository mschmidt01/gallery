...
CodeMirror.defineMode("css", function (config, parserConfig) {
  ...
  return {
    ...
    token: function token(stream, state) {
      ...
      if (style && typeof style != "string") style = ret(style[0], style[1]); // Changing style returned based on context
      ...
      if (style == "variable") {
        ...
        if (context == "propertyValue") {
          ...
          if (propertyKeywords.hasOwnProperty(word)) {// do nothing, remains "property"
      ...
      if (type == "{") {
        ...
        if (context == "interpolation") style = "operator"; // Pop off end of array until { is reached
