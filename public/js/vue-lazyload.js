    ...
    return b(e, [{
      ...
      value: function value() {
        ...
        return this.attempt > this.options.attempt - 1 && this.state.error ? (this.options.silent || console.log("VueLazyload log: " + this.src + " tried too more than " + this.options.attempt + " times"), void t()) : this.state.rendered && this.state.loaded ? void 0 : this._imageCache.has(this.src) ? (this.state.loaded = !0, this.render("loaded", !0), this.state.rendered = !0, t()) : void this.renderLoading(function () {
          e.attempt++, e.options.adapter.beforeLoad && e.options.adapter.beforeLoad(e, e.options), e.record("loadStart"), T({
            src: e.src
          }, function (n) {
    ...
    return function () {
      function t(e) {
        ...
        y(this, t), this.version = "1.3.3", this.mode = A.event, this.ListenerQueue = [], this.TargetIndex = 0, this.TargetQueue = [], this.options = {
          ...
          observer: !!g,
          observerOptions: m || W
        }, this._initEvent(), this._imageCache = new C({
          max: 200
        }), this.lazyLoadHandler = l(this._lazyLoadHandler.bind(this), this.options.throttleWait), this.setMode(this.options.observer ? A.observer : A.event);
      }
...
/***/ 10:
/*!********************************************!*\
  !*** multi ./resources/js/vue-lazyload.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\Hochschule\Master\2.Semester\BAWAWE\FinalesProjekt\resources\js\vue-lazyload.js */"./resources/js/vue-lazyload.js");
